...
// Given the array nums after the possible rotation and an integer target, returnthe index oftarget if it is in nums,
...
public class ArrayTarget {
    ...
    public static int targetValue(int nums[], int taregt){
